...
def generate_data():
    ...
    wind_capped_distance_in_km = np.fmin(wind_distance, np.array([SOLAR_CAPPED_DISTANCE*1000]*len(wind_distance)))/1000
...
ax.hist(wind_capped_distance_in_km, bins=SOLAR_CAPPED_DISTANCE, range=(0,SOLAR_CAPPED_DISTANCE), color=colors[0], label="wind", alpha=.7)  
ax.hist(solar_capped_distance_in_km, bins=SOLAR_CAPPED_DISTANCE, range=(0,SOLAR_CAPPED_DISTANCE), color=colors[2], label="solar", alpha=.7)  
